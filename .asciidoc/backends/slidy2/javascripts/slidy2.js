...
// jmi
  init_color_sets: function(){
   if (this.color_sets.length == 0){
     ...
     this.color_sets = ["zero","empty","blue","new","rain"]
   }
  },
  toggle_color_set: function(){
   // toggle to the next color_set
   if (this.color_sets.length > 0){
       var current_color = this.color_sets[this.color_counter];
       document.body.className = document.body.className.replace(current_color, "");
       this.color_counter++;
       if (this.color_counter === 5) {
           this.color_counter = 0;
       }
       document.body.className = document.body.className + " " + this.color_sets[this.color_counter];
   }
  },
